  ...
  return (
    ...
    >
      <div className="p-6 md:p-8 flex flex-col flex-1 relative">
        ...
        <p
          className="font-serif text-lg md:text-xl italic leading-relaxed mb-8 flex-1 text-stone-custom"
        >
          "{msg.text}"
        </p>

        <div className="flex items-center justify-between pt-5 mt-auto border-t border-sand-200]/60">
          <div className="flex items-center gap-4">
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold shadow-sm bg-gold-500 text-white"
            >
          ...
          <button
            ...
            className={`p-2.5 rounded-full transition-colors z-20 ${isRead ? "text-stone-300 hover:text-gold-500 hover:bg-white/70" : "text-gold-500 bg-white shadow-sm border border-sand-200] hover:bg-gold-500 hover:text-white"}`}
