...
const BulkActionsBar: React.FC<BulkActionsProps> = ({
  ...
  <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-xl p-2 flex flex-col md:flex-row justify-between items-center gap-4 animate-in fade-in slide-in-from-top-4 shadow-sm">
    {/* Izquierda: Info */}
    ...
    <div className="flex flex-wrap justify-end items-center gap-2 w-full md:w-auto">
      ...
      <div className="flex items-center bg-white border border-stone-200 rounded-lg p-1 shadow-sm">
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium text-stone-600 hover:text-stone-900 hover:bg-stone-100 transition-colors"
      ...
      <div className="flex items-center bg-white border border-stone-200 rounded-lg p-1 shadow-sm border-b-2 border-b-red-100">
        <button
          onClick={onDelete}
          className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 transition-colors"
