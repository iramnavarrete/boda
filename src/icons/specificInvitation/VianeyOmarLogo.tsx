...
export default function VianeyOmarLogo(props: Props) {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="relative flex flex-col items-center justify-center text-center h-56"
      {...props}
    >
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 aspect-square min-w-[340px] w-[200%] max-w-[400px] bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.28)_0%,transparent_75%)] pointer-events-none -z-10" />

      {/* CÍRCULO: marco animado alrededor del logo. */}
      <div className="absolute h-56 w-full flex flex-col items-center justify-center">
        <div className="relative h-full w-full">
          <motion.div
            aria-hidden
            className="absolute aspect-square h-full rounded-full -ml-1 border border-current pointer-events-none"
            variants={circleVariants}
          />
          <motion.div
            aria-hidden
            className="absolute aspect-square h-full rounded-full mr-1 border border-current pointer-events-none"
            variants={circleVariants}
          />
        </div>
      </div>
      {/* <motion.div
        aria-hidden
        className="absolute aspect-square w-56 -ml-2.5 rounded-full border border-current pointer-events-none"
        variants={circleVariants}
      /> */}

      <div className="h-[244px] w-full flex flex-col items-center justify-center">
        {/* SVG (MONOGRAMA) */}
        <motion.svg
        ...
        <motion.p
          className="font-edwardianScriptItc text-3xl drop-shadow-[2px_2px_2px_rgba(0,0,0,01)]"
        ...
        {/* TEXTO SUPERIOR */}
        <motion.p
          className="font-greatVibes text-base drop-shadow-[2px_2px_2px_rgba(0,0,0,1)]"
