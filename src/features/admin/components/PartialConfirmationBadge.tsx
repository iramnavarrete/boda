...
const PartialConfirmationBadge = ({ guest }: { guest: Guest }) => {
  ...
  return (
    <span className="inline-flex items-center m-0.5 gap-1 p-2 py-0.5 rounded text-[10px] font-bold tracking-wide border border-orange-200 bg-orange-50 text-orange-600">
      <UserMinus size={10} />
