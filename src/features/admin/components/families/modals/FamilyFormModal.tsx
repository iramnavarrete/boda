      ...
      >
        <div className="flex-1 overflow-y-auto p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            {/* ============================================================== */}
            {/* COLUMNA IZQUIERDA: Identidad y Asistencia */}
            {/* ============================================================== */}
            <div className="space-y-5">
              ...
              {/* Ajuste dinámico de sub-grid para Cupos/Confirmados */}
              <div
                className={cn(
                  "grid gap-4",
            ...
            {/* ============================================================== */}
            {/* COLUMNA DERECHA: Datos Extra y Permisos */}
            {/* ============================================================== */}
            <div className="space-y-5">
              {/* WHATSAPP */}
              <div>
              ...
              <div className="space-y-3 pt-2">
                <label className="flex items-center gap-1.5 text-xs font-bold text-charcoal uppercase tracking-wider mb-2 ml-1">
                  <Settings size={14} className="text-stone-400" />
                  Configuración
                </label>

                {/* Niños permitidos (Siempre visible) */}
                <div
                  className={cn(
                    "rounded-xl transition-all",
                    formData.ninosPermitidos
                ...
                >
                  <button
                    type="button"
                    onClick={() => {
                      const newState = !formData.ninosPermitidos;
                      handleTextChange("ninosPermitidos", newState);
                    }}
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Permitir ingreso a niños
                      </span>
                    </div>
                  </button>
                </div>

                {/* Cambios de Asistencia permitidos (Visible al editar) */}
                {isEdit && (
                  <div
                    className={cn(
                      "rounded-xl transition-all",
